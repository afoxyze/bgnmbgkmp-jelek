...
export const DOSSIER_REGISTRY: readonly DossierMeta[] = [
  {
    ...
    lede: "Badan Gizi Nasional memberi kontrak Sistem Informasi Gizi senilai Rp 600 miliar kepada Perum Peruri melalui penunjukan langsung. Peruri secara historis adalah BUMN percetakan dokumen berharga. Entri ini merangkum angka, jalur pengadaan, dan entitas yang muncul di dokumen publik.",
    severity: "CRITICAL",
  ...
  },
  {
    ...
    lede: "PT Agrinas dan jejaring terkaitnya muncul sebagai pelaksana konstruksi puluhan ribu gerai Koperasi Merah Putih. Skalanya besar, vendornya sedikit. Entri ini merangkum angka anggaran, pelaksana, dan relasi yang tercatat di dokumen publik.",
    severity: "VERIFIED",
  ...
  },
  {
    ...
    lede: "Kontrak pengadaan motor listrik senilai Rp 1,4 triliun untuk distribusi Makan Bergizi Gratis dimenangkan PT Yasa Artha. Nama direksi perusahaan tersebut juga tercantum di berkas perkara bansos yang sedang ditangani KPK. Entri ini mencatat fakta-fakta tersebut apa adanya.",
    severity: "ACTIVE",
