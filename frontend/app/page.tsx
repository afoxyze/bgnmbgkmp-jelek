      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px] gap-8 items-start">
        <div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <Link className="data-link-primary" href={SITE_CONFIG.EXPORT_CSV}>
              Unduh CSV
            </Link>
            <Link className="data-link-secondary" href={SITE_CONFIG.EXPORT_JSON}>
              Unduh JSON
            </Link>
    ...
    <footer className="border-t border-[var(--border-base)] py-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <FooterColumn title="Data">
          <FooterLink href={SITE_CONFIG.EXPORT_CSV}>Ekspor CSV</FooterLink>
          <FooterLink href={SITE_CONFIG.EXPORT_JSON}>Ekspor JSON</FooterLink>
