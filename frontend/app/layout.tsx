...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_CONFIG.NAME_LONG,
    template: `%s - ${SITE_CONFIG.NAME_LONG}`,
  },
  description: SITE_CONFIG.DESCRIPTION,
  keywords: SITE_CONFIG.KEYWORDS,
  applicationName: SITE_CONFIG.NAME_LONG,
  authors: [{ name: SITE_CONFIG.NAME_LONG }],
  creator: SITE_CONFIG.NAME_LONG,
  publisher: SITE_CONFIG.NAME_LONG,
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    ...
    locale: "id_ID",
    url: SITE_CONFIG.URL,
    siteName: SITE_CONFIG.NAME_LONG,
